...
var forbiddenNames = ['send', 'connect', 'close', 'allowDomain', 'allowInsecureDomain', 'client', 'domain'];
...
export class LocalConnection extends EventDispatcher {
  ...
  constructor () {
    ...
    var url = new (<any>URL)('http://localhost' /*getCurrentABC().env.url*/);
  ...
  public handleMessage(methodName: string, argsBuffer: ArrayBuffer): void {
    ...
    var errorEvent = new ErrorEvent('asyncError', false, false,
