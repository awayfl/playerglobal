 ...
 * <codeph class="+ topic/ph pr-d/codeph ">inputMode</codeph> property in the flash.ui.Multitouch class.
 * These values set the type of touch events the Flash runtime dispatches
 * when the user interacts with a touch-enabled device.
 */
export class MultitouchInputMode {
	...
	/**
	 * Specifies that events are dispatched only for basic touch events,
	 * such as a single finger tap. When you use this setting,
	 * events listed in the TouchEvent class are dispatched; events listed in the TransformGestureEvent,
	 * PressAndTapGestureEvent, and GestureEvent classes are not dispatched.
	 */
