 ...
 * <codeph class="+ topic/ph pr-d/codeph ">IME.isSupported</codeph> property. See
 * <xref href="http://help.adobe.com/en_US/air/build/WS144092a96ffef7cc16ddeea2126bb46b82f-8000.html"
 * class="- topic/xref ">
 ...
 * <xref href="http://www.microsoft.com/globaldev/default.mspx" scope="external"
 * class="- topic/xref ">http://www.microsoft.com/globaldev/default.mspx</xref></li>
 * <li class="- topic/li "><xref href="http://developer.apple.com/documentation/"
 * scope="external" class="- topic/xref ">http://developer.apple.com/documentation/</xref></li>
 * <li class="- topic/li "><xref href="http://java.sun.com" scope="external"
 * class="- topic/xref ">http://java.sun.com</xref></li></ul></p><p class="- topic/p ">
 * If an IME is not active on the user's computer, calls to IME methods or properties,
 * other than <codeph class="+ topic/ph pr-d/codeph ">Capabilities.hasIME</codeph>,
 ...
 * <adobetable class="innertable"><tgroup cols="4" class="- topic/tgroup ">
 * <thead class="- topic/thead "><row class="- topic/row "><entry class="- topic/entry ">Capability</entry>
 * <entry class="- topic/entry ">Windows</entry><entry class="- topic/entry ">Mac OSX</entry>
 * <entry class="- topic/entry ">Linux</entry></row></thead><tbody class="- topic/tbody ">
 * <row class="- topic/row "><entry class="- topic/entry ">Determine whether the IME is installed:
 * <codeph class="+ topic/ph pr-d/codeph ">Capabilities.hasIME</codeph></entry>
 * <entry class="- topic/entry ">Yes</entry><entry class="- topic/entry ">Yes</entry>
 * <entry class="- topic/entry ">Yes</entry></row><row class="- topic/row ">
 * <entry class="- topic/entry ">Set IME on or off: <codeph class="+ topic/ph pr-d/codeph ">IME.enabled</codeph>
 * </entry><entry class="- topic/entry ">Yes</entry><entry class="- topic/entry ">Yes</entry>
 * <entry class="- topic/entry ">Yes</entry></row><row class="- topic/row ">
 * <entry class="- topic/entry ">Find out whether IME is on or off:
 * <codeph class="+ topic/ph pr-d/codeph ">IME.enabled</codeph></entry><entry class="- topic/entry ">Yes</entry>
 * <entry class="- topic/entry ">Yes</entry><entry class="- topic/entry ">Yes</entry></row><row class="- topic/row ">
 * <entry class="- topic/entry ">Get or set IME conversion mode:
 * <codeph class="+ topic/ph pr-d/codeph ">IME.conversionMode</codeph></entry><entry class="- topic/entry ">Yes</entry>
 * <entry class="- topic/entry ">Yes ~~~~</entry><entry class="- topic/entry ">No</entry></row>
 * <row class="- topic/row "><entry class="- topic/entry ">Send IME the string to be converted:
 * <codeph class="+ topic/ph pr-d/codeph ">IME.setCompositionString()</codeph></entry>
 * <entry class="- topic/entry ">Yes ~~</entry><entry class="- topic/entry ">No</entry>
 * <entry class="- topic/entry ">No</entry></row><row class="- topic/row ">
 * <entry class="- topic/entry ">Get from IME the original string before conversion:
 * <codeph class="+ topic/ph pr-d/codeph ">System.ime.addEventListener()</codeph></entry>
 * <entry class="- topic/entry ">Yes ~~</entry><entry class="- topic/entry ">No</entry>
 * <entry class="- topic/entry ">No</entry></row><row class="- topic/row ">
 * <entry class="- topic/entry ">Send request to convert to IME: <codeph class="+ topic/ph pr-d/codeph ">
 * IME.doConversion()</codeph></entry><entry class="- topic/entry ">Yes ~~</entry>
 * #<entry class="- topic/entry ">No</entry><entry class="- topic/entry ">No</entry>
 * </row></tbody></tgroup></adobetable><p class="- topic/p ">~~ Not all Windows IMEs support all of these operations.
 * The only IME
 * that supports them all is the Japanese IME.</p><p class="- topic/p ">~~~~
 * On the Macintosh, only the Japanese IME supports these methods, and third-party IMEs do not support them.</p>
...
export class IME extends EventDispatcher {
	 ...
	 * ALPHANUMERIC_FULLALPHANUMERIC_HALFCHINESEJAPANESE_HIRAGANAJAPANESE_KATAKANA_FULLJAPANESE_
	 * KATAKANA_HALFKOREANUNKNOWN (read-only value; this value cannot be set)
