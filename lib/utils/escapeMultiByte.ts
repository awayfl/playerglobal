 ...
 * @return	An escaped copy of the input string.  If System.useCodePage is true,
 ...
 * on different systems, such as "CrÃ¼e" on a Latin system.
...
export const escapeMultiByte = function(value: string): string {
	// @todo
	Debug.throwPIR('playerglobals/utils/escapeMultiByte', 'escapeMultiByte', '');
	return '';
};