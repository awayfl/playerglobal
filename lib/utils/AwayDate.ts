...
export class AwayDate {
	...
	//yearOrTimevalue:number,month:number,date:number,hour:number,minute:number,second:number,millisecond:number){
	constructor(param1: any = 0, param2: number = 0, param3: number = 0) {
		// @todo
		Debug.throwPIR('playerglobals/utils/AwayDate', 'AwayDate-constructor', '');
	}
