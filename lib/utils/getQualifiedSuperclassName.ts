 ...
 * you can convert the class name to a class reference with the getDefinitionByName()
 * function.Note: This function restricts itself to instance hierarchies, whereas the describeType() function
 * uses class object hierarchies if the value parameter is a data type.
 * Calling describeType() on a data type returns the
 * superclass based on the class object hierarchy, in which all class objects inherit from Class.
 * The getQualifiedSuperclassName()
 * function, however, ignores the class object hierarchy
...
export const getQualifiedSuperclassName = function(name: any) {
	// @todo
	Debug.throwPIR('playerglobals/utils/getQualifiedSuperclassName', 'getQualifiedSuperclassName', '');
	return '';
};